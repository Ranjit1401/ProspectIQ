...
import { ChevronDown, Globe, Users, Brain, ShieldAlert, ListChecks, GitBranch, Sparkles } from "lucide-react";
...
const STATUS_VARIANT: Record<AuditEvent["status"], "success" | "warning" | "outline"> = {
  success: "success",
  warning: "warning",
  info: "outline",
};
            ...
            >
              <div
                className={cn(
                  ...
                  event.status === "success" && "border-emerald-500/30 text-emerald-400",
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-2.5">
                    <span className="text-[13px] font-medium text-white/85">{event.event}</span>
